...
<html><head>
    ...
    <link rel="canonical" href="/account/unitivesignup?service=maoyan&amp;continue=http%3A%2F%2Fmaoyan.com%2Fpassport%2Flogin%3Fredirect%3D%252F">
 ...
 -->
    ...
    <link rel="stylesheet" type="text/css" href="css/index.12eff53.css">



   <!--  <script async="" src="//s0.meituan.com/bs/js/?f=mta-js:mta.min.js"></script><script>
...
<body class="pg-unitive-signup theme--maoyan">
    ...
    <form action="/account/unitivesignup" method="POST">
            ...
            <span class="inline-tip"></span></div>
            <div class="form-field form-field--pwd form-field--ok">
        ...
        <input type="hidden" name="fingerprint" class="J-fingerprint" value="0-2-1-3i0|1s|1c|av|1c|15|a8|14|1k|ag|1b|1d|u8|1k|1c|d4|1c|w|io|1b|14|dt|1c|14|c8|14|14|mg|14|1s|a0|1c|14|bk|1c|o|cg|1d|1b">
    </form>
</div>
...
<span id="csrf" style="display:none">neRAZb16-iwooydptN9EkRx5fZHjrNSimXXw</span>
